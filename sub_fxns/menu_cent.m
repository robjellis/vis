...
%
% modified by RJE to center a menu
...
winTopGap   = screeny/4;       % gap between top of screen and top of figure **
winLeftGap  = screenx/2.25;       % gap between side of screen and side of figure **
